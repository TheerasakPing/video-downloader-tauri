...
import { Download, X, RefreshCw, Sparkles, ArrowUpCircle } from "lucide-react";
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 animate-fade-in">
      ...
      <div className="relative glass rounded-2xl border border-slate-700/50 p-6 max-w-md w-full shadow-2xl animate-scale-in">
        ...
        {/* Error message */}
        {error && (
          <div className="mb-4 p-3 bg-red-500/20 rounded-lg border border-red-500/30 text-red-300 text-sm animate-fade-in">
            {error}
          </div>
        )}
