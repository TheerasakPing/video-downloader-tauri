...
export default function SeriesDetail({ detail, onBack, onRemove, onRefetch }: SeriesDetailProps) {
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-2">
        {episodes.map((ep) => (
          <div key={ep.id} className={`p-3 rounded-lg border text-center text-sm ${getStatusColor(ep.status)}`}>
